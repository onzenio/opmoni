...
- [ ] 4.3 Executar cenários manuais autenticados (criar Fiscal/Pessoal, vincular Felipe Galvão aos dois, listar diretório como operador e user sem email, 403 de escrita para user, isolamento entre accounts, auditoria de suporte); verificar HTTP e estado persistido conformes às specs.
